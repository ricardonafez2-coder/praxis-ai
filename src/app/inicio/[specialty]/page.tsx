...
const specialtyMeta: Record<string, { icon: string; title: string; subtitle: string; gradient: string }> = {
  ...
  nutricion: {
    icon: '🥗',
    title: 'Nutrición',
    subtitle: 'Evaluación nutricional, plan alimenticio y entrevista motivacional con pacientes virtuales.',
  ...
  return (
    <header className="border-b border-gray-800 bg-gray-900/50 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-8 py-4 flex items-center justify-between">
        <Link href="/inicio" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
...
export default function SpecialtyPage() {
  ...
  // Read student info from localStorage (set by /alumno/ingresar)
  const studentName = typeof window !== 'undefined'
    ? localStorage.getItem('praxis_student_name') || 'Estudiante'
    : 'Estudiante';
  const studentId = typeof window !== 'undefined'
    ? localStorage.getItem('praxis_student_id') || ''
    : '';
    ...
    return (
      <div className="min-h-screen bg-gray-950">
        ...
        <div className="p-8 max-w-6xl mx-auto text-center">
          ...
          <Link href="/inicio" className="text-blue-400 hover:text-blue-300 font-medium">
            ← Volver al inicio
          </Link>
        </div>
      </div>
        ...
        <div className="min-h-screen bg-gray-950">
          ...
          <div className="border-b border-gray-800">
            <div className="max-w-6xl mx-auto px-8 py-8">
              <Link href="/inicio" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-300 text-sm mb-4 transition-colors">
                ← Volver al inicio
              </Link>
              <div className="flex items-center gap-4">
